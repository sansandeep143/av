...
if (file_exists(JPATH_SITE.DS.'components'.DS.'com_fsf'.DS.'helper'.DS.'helper.php'))
{
	...
	function &plgSearchFSFGlossaryAreas()
	{
		static $areas = array(
			'Glossary' => 'Glossary'
			);
	...
	class plgSearchFSF_Glossary extends JPlugin
	{
		/**
			* Constructor
			*
	...
	if (!FSF_Helper::Is16())
	{
		$mainframe->registerEvent( 'onSearch', 'plgSearchFSFGlossary' );
		$mainframe->registerEvent( 'onSearchAreas', 'plgSearchFSFGlossaryAreas' );

		JPlugin::loadLanguage( 'plg_search_Glossary' );
	} else {
