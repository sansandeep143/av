...
************************************************************************************************************/	
	...
	var form_widget_amount_slider_handle = 'components/com_fsf/assets/colpickimg/slider_handle.gif';
		...
		do{			
			if(subDiv.tagName=='DIV' && subDiv.className!='colorPickerCloseButton'){
				if(subDiv==thisObj){
					...
					img.src = "components/com_fsf/assets/colpickimg/tab_right_active.gif"
					...
					img.src = "components/com_fsf/assets/colpickimg/tab_right_inactive.gif";
					if(activeColorDiv)
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){			
			...
			tabImg.src = "components/com_fsf/assets/colpickimg/tab_right_" + suffix + ".gif";
