...
<div id="singleimage">
    ...
    <div class="btn-group">
        ...
        <a class="btn singleimage-zoom" href="<?php echo $this->file->getImageUrl(NULL, NULL, true) ?>"><i class="eventgallery-icon-zoom-in"></i></a>
    ...
    <div class="singleimage eventgallery-imagelist" data-rowheight="100" data-rowheightjitter="0" data-firstimagerowheight="1" data-dofilllastrow="true">
        ...
        <?php    $seoMode = JRequest::getVar('_escaped_fragment_', false);
        if ($seoMode !== false) {
            $seoMode = true;
        }
        if ($seoMode) {
        ...
        <a class="thumbnail"
           ...
           data-eventgallery-lightbox="gallery<?php echo $this->params->get('use_fullscreen_lightbox', 0) == 1 ? 'fullscreen' : ''; ?>"
