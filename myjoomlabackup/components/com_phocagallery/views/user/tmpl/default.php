...
if ($this->tmpl['displaytabs'] > 0) {
	...
	echo JHtml::_('tabs.panel', JHtml::_( 'image', $this->tmpl['pi'].'icon-user.'.$this->tmpl['fi'], '') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_USER'), 'user' );
	...
	echo JHtml::_('tabs.panel', JHtml::_( 'image', $this->tmpl['pi'].'icon-folder-small.'.$this->tmpl['fi'], '') . '&nbsp;'.$this->tmpl['categorycreateoredithead'], 'category' );
	...
	echo JHtml::_('tabs.panel', JHtml::_( 'image', $this->tmpl['pi'].'icon-subcategories.'.$this->tmpl['fi'], '') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_SUBCATEGORIES'), 'subcategories' );
	echo $this->loadTemplate('subcategories');
	//echo $pane->endPanel();

	//echo $pane->startPanel( JHtml::_( 'image', $this->tmpl['pi'].'icon-images.'.$this->tmpl['fi'],'') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_IMAGES'), 'images' );
	echo JHtml::_('tabs.panel', JHtml::_( 'image', $this->tmpl['pi'].'icon-images.'.$this->tmpl['fi'],'') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_IMAGES'), 'images' );
