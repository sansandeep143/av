...
if ($this->tmpl['displaytabs'] > 0) {
	...
	echo JHtml::_('tabs.start', 'config-tabs-com_phocagallery-m', array('useCookie'=>1, 'startOffset'=> $this->tmpl['tab']));
	...
	echo JHtml::_('tabs.panel', JHtml::_( 'image', 'administrator/components/com_phocagallery/assets/images/icon-16-upload.png','') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_UPLOAD'), 'upload' );
	...
	if((int)$this->tmpl['enablemultiple']  >= 0) {
		...
		echo JHtml::_('tabs.panel', JHtml::_( 'image', 'administrator/components/com_phocagallery/assets/images/icon-16-upload-multiple.png','') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_MULTIPLE_UPLOAD'), 'multipleupload' );
	...
	if($this->tmpl['enablejava'] >= 0) {
		...
		echo JHtml::_('tabs.panel', JHtml::_( 'image', 'administrator/components/com_phocagallery/assets/images/icon-16-upload-java.png','') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_JAVA_UPLOAD'), 'javaupload' );
