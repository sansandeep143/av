...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo JViewLegacy::escape($this->faqcat->title);?>" />
			</td>
		</tr>
		<?php FSFAdminHelper::LA_Form($this->faqcat); ?>
		<tr>
			<td width="135" align="right" class="key">
				<label for="image">
