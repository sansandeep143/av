...
<form action="<?php echo FSFRoute::x( 'index.php?option=com_fsf&view=faqs' );?>" method="post" name="adminForm" id="adminForm">
...
<div id="editcell">
    ...
    for ($i=0, $n=count( $this->data ); $i < $n; $i++)
    {
        ...
        $link = FSFRoute::x( 'index.php?option=com_fsf&controller=faq&task=edit&cid[]='. $row->id );

		$published = FSF_GetPublishedText($row->published);
    	$featured = FSF_GetFeaturedText($row->featured);
