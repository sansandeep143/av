...
<div class="methodinformation">
    ...
    <?php IF ($lineitemcontainer->getPaymentMethod() != NULL):
        $contentPayment = $lineitemcontainer->getPaymentMethod()->getMethodReviewContent($lineitemcontainer);
    ?>
    ...
    <?php IF ($lineitemcontainer->getShippingMethod() != NULL):
        $contentShipping = $lineitemcontainer->getShippingMethod()->getMethodReviewContent($lineitemcontainer);
    ?>
    ...
    <?php IF ($lineitemcontainer->getSurcharge() != NULL):
        $contentSurcharge = $lineitemcontainer->getSurcharge()->getMethodReviewContent($lineitemcontainer);
    ?>
