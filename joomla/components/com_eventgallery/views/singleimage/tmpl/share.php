...
<a href="#" style="float: left" class="social-share-button social-share-button-close"><i class="big"></i></a>	 
	...
	<?php IF ($this->params->get('use_social_sharing_google', 0)==1 && $this->model->folder->getAttribs()->get('use_social_sharing_google',1)==1):?>			    
		<a href="https://plus.google.com/share?url=<?php echo urlencode($this->link)?>" onclick="javascript:window.open(this.href,
		  '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes');return false;"><img src="<?php echo JUri::base().'media/com_eventgallery/frontend/images/social/32/google.png' ?>" alt="Google+" title="Google+"></a>
	<?php ENDIF ?>
	...
	<?php IF ($this->params->get('use_social_sharing_twitter', 0)==1 && $this->model->folder->getAttribs()->get('use_social_sharing_twitter',1)==1):?>			    
		<a href="https://twitter.com/intent/tweet?source=webclient&text=<?php echo $this->twitter?>" 
		   ...
		   ><img src="<?php echo JUri::base().'media/com_eventgallery/frontend/images/social/32/twitter.png' ?>" alt="Twitter" title="Twitter"></a>
	<?php ENDIF ?>
	...
	<?php IF ($this->params->get('use_social_sharing_pinterest', 0)==1 && $this->model->folder->getAttribs()->get('use_social_sharing_pinterest', 1)==1):?>			    
		<a href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode($this->link)?>&media=<?php echo urlencode($this->image)?>&description=<?php echo htmlspecialchars($this->displayname, ENT_COMPAT, 'UTF-8')?>"
		  ...
		  '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes');return false;"><img src="<?php echo JUri::base().'media/com_eventgallery/frontend/images/social/32/interest.png' ?>" alt="Pinterest" title="Pinterest"></a>
	<?php ENDIF ?>

	<?php IF ($this->params->get('use_social_sharing_email', 0)==1 && $this->model->folder->getAttribs()->get('use_social_sharing_email', 1)==1):?>			    
		<a href="mailto:?subject=<?php echo htmlspecialchars($this->subject, ENT_COMPAT, 'UTF-8') ?>&body=<?php echo urlencode($this->link)?>" onclick=""> <img src="<?php echo JUri::base().'media/com_eventgallery/frontend/images/social/32/email.png' ?>" alt="Mail" title="Mail"></a>
	<?php ENDIF ?>

	<?php IF ($this->params->get('use_social_sharing_download', 0)==1 && $this->model->folder->getAttribs()->get('use_social_sharing_download', 1)==1):?>			    
		<a download="<?php echo $this->imagename;?>" href="<?php echo $this->downloadimageurl; ?>" target="_blank" lt="Download" title="Download"><img src="<?php echo JUri::base().'media/com_eventgallery/frontend/images/icons/32x32/download-icon.png' ?>" alt="Download" title="Download"</a>
	<?php ENDIF ?>
