<?php
/**
* Joomla! POWr Event Gallery
*
* @version 2.0
* @author POWr.io
* @package POWr Event Gallery
* @subpackage POWr
      ...
      public function add_powr_js(){
        ...
        if($POWR_JS_ADDED){
          return;
		    ...
		    $js_url = JURI::base()."modules/mod_powreventgallery/powr_joomla.js";
        $js = "(function(d){
...
//Create Helper
new PowrHelper();
echo "<div class='powr-event-gallery' label='joomla_$module->id'></div>";
?>