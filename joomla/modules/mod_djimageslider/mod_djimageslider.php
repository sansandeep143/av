<?php
/**
 * @version $Id: mod_djimageslider.php 28 2015-07-27 11:35:02Z szymon $
...
if ($jquery) {
	...
	$document->addScript('modules/mod_djimageslider/assets/js/slider.js?v='.$ver, 'text/javascript', $canDefer);
} else {
	JHTML::_('behavior.framework', true);
	$document->addScript('modules/mod_djimageslider/assets/js/moo.slider.js?v='.$ver, 'text/javascript', $canDefer);
}
