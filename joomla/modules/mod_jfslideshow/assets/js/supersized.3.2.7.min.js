...
(function($){
    ...
    $.supersized = function(options){
		...
		base.nextSlide = function(){
		    ...
		    //base.options.transition = 0;
		    if(base.options.transition == 8) // random
		    {	
		    	base.options.random_transition = 1;		    	
			}
			if(base.options.random_transition){
				base.options.transition = Math.floor(Math.random() * (7 - 1 + 1)) + 1;
			}
	    	switch(base.options.transition){
	    		...
	    		case 3: case 'slideRight':	// Slide Right
	    			nextslide.animate({left : base.$el.width()}, 0 ).css('visibility','visible').animate({ left:0, avoidTransforms : false }, base.options.transition_speed, 'easeOutQuad', function(){ base.afterAnimation(); });
	    			break;
